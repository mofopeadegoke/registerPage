    ...
    <>
      <article className="regBoxBody">
        ...
        <form action="https://formspree.io/f/xpwaqrgl" method="POST">
          ...
          <div className="thirdRow gridRow">
            <label className="col">
              <span>
                Leadership Position <span className="red">*</span>
              </span>
              <input type="text" name="lPosition" required />
            </label>
          </div>
          <div className="fourthRow gridRow">
            <label className="col">
              <span>Gender</span>
              <label className="labelRad">
